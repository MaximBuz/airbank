<template>
  ...
  <div class="flex align-center justify-end gap-2 mt-1">
    <button v-if="showMoreEnabled" class="rounded-sm border p-2 hover:border-gray-300 hover:bg-gray-50 hover:scale-105" @click="previousPage">
    ...
    <button v-if="showMoreEnabled" class="rounded-sm border p-2 hover:border-gray-300 hover:bg-gray-50 hover:scale-105" @click="nextPage">
